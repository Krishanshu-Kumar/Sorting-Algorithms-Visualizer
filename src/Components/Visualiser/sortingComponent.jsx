...
function SortingComponent() {
	...
	useEffect(() => { //ye react ke syntax 
		resetArr();
	}, [])

// ye function bar ki length ko height and length ration ko adjust karta hai 
	...
	return (
		...
		{/* creating nav bar */}
			...
			<img src="https://play-lh.googleusercontent.com/3AIeSG0MgjUjA-oOYOoSCu802l5Lv5D96brKajRdf01r2IavfOhcmrs_JhkSfhndyA" className="gtbit_logo" alt="" />
				<h3>Minor Project- The Sorting Visualizer</h3>
				...
				<div><button className='btn' id='msort' onClick={mergeSort}>MergeSort</button></div>
